...
#   Add bash completion
#   This will activate bash completion
#   ------------------------------------------------------------
...
alias pd="pwd"															# Show working directory
alias cp='cp -aiv'                           # Preferred 'cp' implementation
alias mv='mv -iv'                           # Preferred 'mv' implementation
alias mkdir='mkdir -pv'                     # Preferred 'mkdir' implementation
alias ll='ls -FGlAhp'                       # Preferred 'ls' implementation
alias lsd='ls -d */'												# See only directories under current, and don't list full contents.
...
# 	Function to change directories by replacing one part of name in path.
# 	e.g. switch from: /home/users/joey/really/long/path to: /home/users/boby/really/long/path
# 	syntax: cdp joey boby
#   --------------------------------------------------------------------
function cdp () {
cd ${PWD/${1}/${2}}
}
...
cd='[cd_func](https://github.com/camillobruni/script/blob/master/cd_func.sh "cd_func")'
...
if [ -d ~/.docker/machine/machines/calypso ]; then
	export DOCKER_TLS_VERIFY=1
	export DOCKER_HOST=tcp://$(docker-machine ip calypso):2376
	export DOCKER_CERT_PATH=~/.docker/machine/machines/calypso
	export DOCKER_MACHINE_NAME=calypso
fi
...
alias npmint="npm run integration"
...
#   Function to copy a elasticsearch production index do development elasticsearch (dev env).
#   e.g. switch from: https://elasticsearch.besedo-ops.com/sourceIndex to: http://localhost:9200/targetIndex
#   syntax: cdp index
#   --------------------------------------------------------------------
function copyProIndex () {
    curl -X DELETE http://192.168.29.2:9200/${1}*

    elasticdump \
      --input=https://elasticsearch.besedo-ops.com/${1} \
      --output=http://192.168.29.2:9200/${1} \
      --type=mapping
    elasticdump \
      --input=https://elasticsearch.besedo-ops.com/${1} \
      --output=http://192.168.29.2:9200/${1} \
...
#   Show working git branch on iterm2 
#   ------------------------------------------------------------
